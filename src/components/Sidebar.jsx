...
export default function Sidebar({ isOpen, onClose, darkMode, onToggleDark, user, profile, isLoggedIn, onSignOut }) {
  ...
  return (
    <>
      ...
      <aside className={`
        ...
        w-72 bg-white dark:bg-gray-900 border-r border-gray-200/60 dark:border-gray-800/60
      ...
      `}>
        ...
        <div className="p-5 pb-4 border-b border-gray-100 dark:border-gray-800/60">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 flex items-center justify-center rounded-xl text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors touch-bounce"
            >
              ✕
            </button>
          </div>
        ...
        <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
          ...
          <button
            disabled
            className="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm text-gray-300 dark:text-gray-700 w-full font-medium"
          >
        ...
        <div className="p-3 border-t border-gray-100 dark:border-gray-800/60 space-y-1">
          ...
          {isLoggedIn ? (
            ...
            <NavLink
              to="/login"
              onClick={onClose}
              className="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800/80 transition-all touch-bounce"
            >
              <span className="text-xl">👤</span>
              Đăng nhập
            </NavLink>
